...
_Status: done — seventeen of eighteen tickets resolved, verified on an iPhone 2026-08-16. The one still open is [11](../.scratch/phase-1-10-continuous-hls-playback/issues/11-the-standalone-pwa-is-killed-while-backgrounded.md), which is needs-info and parked rather than pending: one sighting, two non-reproductions, reopen if it is seen again_
