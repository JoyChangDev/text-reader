...
- [x] Phase 1.10 tickets 04 and 06 are re-triaged now that a live store is available to them. _Both **resolved** 2026-08-11. Ticket 06's question is answered yes in every run; ticket 04's last item — cross-origin segment fetching on a device — was re-checked against the Worker that replaced Vercel Blob, and the subject had changed underneath it, which is the sort of thing a re-triage is for. The device session also opened four new tickets: [11](../../phase-1-10-continuous-hls-playback/issues/11-the-standalone-pwa-is-killed-while-backgrounded.md), [12](../../phase-1-10-continuous-hls-playback/issues/12-the-playlist-route-reads-the-whole-book-per-poll.md), [13](../../phase-1-10-continuous-hls-playback/issues/13-deleting-a-book-leaves-its-chunk-index-in-redis.md) and [14](../../phase-1-10-continuous-hls-playback/issues/14-the-durable-resume-snapshot-is-almost-never-written.md)._
