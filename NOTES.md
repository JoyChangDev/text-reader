...
- 2026-07-25: Lesson 0007 exercise (two-book cache-key isolation test in `progressiveGeneration.test.js`) done and green, staged but not committed. See [[0005-vi-hoisted-cache-key-recall]]. Ticket 05 closed (`530d4ac`) since last session but ticket 06 (upload/playback UI) is still `ready-for-agent` - the async findBy/waitFor lesson is still blocked, same gap as 2026-07-23.
